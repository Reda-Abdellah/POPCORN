...
out_filepath= lambda x: 'weights/data_gen_iqda_isbi_TSNE3_all_'+"%02d" % (x)+'.h5'
...
update_data_folder(model,unlabeled_indxs,listaT1,listaFLAIR,datafolder=datafolder,regularized=regularized)
