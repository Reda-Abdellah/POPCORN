...
out_filepath= lambda x: 'weights/data_gen_iqda_2it_volbrain_TSNE3_bottleneckRegulirized_'+regularized_loss+'__'+str(loss_weights[0])+'_'+str(loss_weights[1])+'__tsne1_'+"%02d" % (x)+'.h5'
...
labeled_tsne,unlabeled_tsne= tsne(bottleneck_features_labeled, bottleneck_features_unlabeled,n_components=1)
bundles=[]
for i in range(29):
    bundle= give_n_closest_loop(ranks,n_indxs=100)
