...
out_filepath= lambda x: 'weights/data_gen_iqda_2it_volbrain_TSNE3_bottleneckRegulirized_'+regularized_loss+'__'+str(loss_weights[0])+'_'+str(loss_weights[1])+'__closest_clusterbycluster_'+"%02d" % (x)+'.h5'
...
cluster_dis_from_labeled= brute_force_rank(centroids_u, centroids_l)
